...
# Input
name = "Judy El Shentnawy"
grade = 11
favourite_exclamation = "ew"
...
print(
    ...
    + f"To make me feel better my mom made my favourite thing to eat {fav_food}. "
    + f"After dinner, I decided to watch {fav_show} and I went to bed at {sleep_time}. "
